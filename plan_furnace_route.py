...
free.difference_update([(-10, 45), (18, 56)])
D=[(0,-1),(1,0),(0,1),(-1,0)];start=(-10,46,2,False);end=(18,55)
...
route.reverse();json.dump(route,open('plans/furnace-route.json','w'),indent=2)
