...
free={(x,y) for x,y in land if -45<=x<=42 and -10<=y<=45}
for e in s['entities']:
...
free.difference_update([(-39,21),(30,26)])
for e in s['entities']:
...
D=[(0,-1),(1,0),(0,1),(-1,0)];start=(-37,21,1,False);end=(33,26)
...
route.reverse();json.dump(route,open('plans/military-lab-route.json','w'),indent=2)
