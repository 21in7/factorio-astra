...
free.difference_update([(-33,-54),(-49,-65)])
for e in s['entities']:
...
D=[(0,-1),(1,0),(0,1),(-1,0)];start=(-35,-54,3,False);end=(-49,-64)
...
route.reverse();json.dump(route,open('plans/brick-coal-route.json','w'),indent=2)
