...
free.difference_update([(-34,-76),(-27,-75),(-26,-73)])
for e in s['entities']:
...
D=[(0,-1),(1,0),(0,1),(-1,0)];start=(-34,-77,0,False);end=(-26,-75)
...
route.reverse();json.dump(route,open('plans/copper-coal-sixth-route.json','w'),indent=2)
