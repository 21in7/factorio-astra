...
free={(x,y) for x,y in land if -118<=x<=-108 and -74<=y<=-56}
for e in s['entities']:
...
free.difference_update([(-117,-61),(-113,-68)])
for e in s['entities']:
...
D=[(0,-1),(1,0),(0,1),(-1,0)];start=(-116,-61,1,False);end=(-112,-68)
...
route.reverse();json.dump(route,open('plans/frame-steel-route.json','w'),indent=2)
