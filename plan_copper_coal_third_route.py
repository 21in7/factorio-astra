...
free={(x,y) for x,y in land if -65<=x<=22 and -90<=y<=71}
for e in s['entities']:
...
free.difference_update([(-23,-85),(-31,-83),(-23,-86),(-32,-85)])
for e in s['entities']:
...
D=[(0,-1),(1,0),(0,1),(-1,0)];start=(-23,-87,3,False);end=(-32,-83)
...
route.reverse();json.dump(route,open('plans/copper-coal-third-route.json','w'),indent=2)
