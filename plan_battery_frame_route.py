...
free={(x,y) for x,y in land if -125<=x<=-86 and -80<=y<=-48}
for e in s['entities']:
...
free.difference_update([(-97,-60),(-117,-68),(-95,-59)])
for e in s['entities']:
...
D=[(0,-1),(1,0),(0,1),(-1,0)];start=(-97,-59,2,False);end=(-118,-68)
...
route.reverse();json.dump(route,open('plans/battery-frame-route.json','w'),indent=2)
