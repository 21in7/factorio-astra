...
free={(x,y) for x,y in land if -20<=x<=12 and 7<=y<=24}
for e in s['entities']:
...
D=[(0,-1),(1,0),(0,1),(-1,0)];start=(-7,9,3,False);end=(-7,21)
...
route.reverse();json.dump(route,open('plans/red-ec-route.json','w'),indent=2)
