...
free={(x,y) for x,y in land if -140<=x<=-20 and -100<=y<=-45}
for e in s['entities']:
...
free.difference_update([(-30,-78),(-30,-77),(-125,-61)])
for e in s['entities']:
...
D=[(0,-1),(1,0),(0,1),(-1,0)];start=(-30,-76,2,False);end=(-125,-62)
...
route.reverse();json.dump(route,open('plans/lds-copper-route.json','w'),indent=2)
