...
free.difference_update([(-40,-75),(-33,-75)])
for e in s['entities']:
...
D=[(0,-1),(1,0),(0,1),(-1,0)];start=(-41,-75,3,False);end=(-34,-75)
...
route.reverse();json.dump(route,open('plans/copper-coal-fifth-route.json','w'),indent=2)
