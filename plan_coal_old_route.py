...
s['entities']=[e for e in s['entities'] if not(e['name']=='small-electric-pole' and e['position'] in [{'x':-5.5,'y':37.5},{'x':-3.5,'y':37.5}])]
for e in s['entities']:
...
free.difference_update([(-29,28),(-6,39),(-3,39),(0,39)])
for e in s['entities']:
...
D=[(0,-1),(1,0),(0,1),(-1,0)];start=(-27,28,1,False);end=(-6,37)
...
route.reverse();json.dump(route,open('plans/coal-old-route.json','w'),indent=2)
