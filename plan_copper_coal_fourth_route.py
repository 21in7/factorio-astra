...
free.difference_update([(-35,-84),(-37,-75),(-38,-77)])
for e in s['entities']:
...
D=[(0,-1),(1,0),(0,1),(-1,0)];start=(-37,-84,3,False);end=(-38,-75)
...
route.reverse();json.dump(route,open('plans/copper-coal-fourth-route.json','w'),indent=2)
