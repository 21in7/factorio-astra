...
free={(x,y) for x,y in land if -108<=x<=24 and -128<=y<=-65}
for e in s['entities']:
...
free.difference_update([(19,-117),(16,-120),(-96,-73),(-95,-73),(-95,-68),(-95,-67),(-96,-67),(-97,-67),(-97,-66)])
for e in s['entities']:
...
D=[(0,-1),(1,0),(0,1),(-1,0)];start=(18,-117,3,False);end=(-95,-74)
...
while q:
 ...
 x,y,di,lock=n
 if (x,y)==end and not lock and di==2:break
...
route.reverse();json.dump(route,open('plans/remote-iron-route.json','w'),indent=2)
