...
free.difference_update([(-92,-69),(-95,-64),(-93,-67)])
for e in s['entities']:
...
D=[(0,-1),(1,0),(0,1),(-1,0)];start=(-92,-67,2,False);end=(-94,-64)
...
route.reverse();json.dump(route,open('plans/battery-copper-route.json','w'),indent=2)
