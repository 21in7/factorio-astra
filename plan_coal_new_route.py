...
free.difference_update([(-29,26),(-6,58),(-3,58),(0,58)])
for e in s['entities']:
...
D=[(0,-1),(1,0),(0,1),(-1,0)];start=(-27,26,1,False);end=(-6,60)
...
route.reverse();json.dump(route,open('plans/coal-new-route.json','w'),indent=2)
