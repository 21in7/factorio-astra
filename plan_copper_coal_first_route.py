...
free.difference_update([(-12,-83),(-16,-75)])
for e in s['entities']:
...
D=[(0,-1),(1,0),(0,1),(-1,0)];start=(-14,-83,3,False);end=(-15,-75)
...
route.reverse();json.dump(route,open('plans/copper-coal-first-route.json','w'),indent=2)
