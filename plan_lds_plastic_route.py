...
free={(x,y) for x,y in land if -135<=x<=-85 and -90<=y<=-50}
for e in s['entities']:
...
free.difference_update([(-89,-81),(-125,-59)])
for e in s['entities']:
...
D=[(0,-1),(1,0),(0,1),(-1,0)];start=(-90,-81,3,False);end=(-125,-58)
...
route.reverse();json.dump(route,open('plans/lds-plastic-route.json','w'),indent=2)
